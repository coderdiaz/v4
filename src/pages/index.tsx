  ...
  return <Layout>
    ...
    <section className="py-5 md:py-10 lg:pt-10 lg:pb-5 bg-repeat-x">
      <Container className="max-w-3xl">
        <h1 className="text-3.5xl font-inter font-bold md:text-4xl text-gray-200 leading-tight mb-6">
          Hola, soy Javier Diaz
        </h1>
        <p className="text-gray-300 md:text-lg leading-loose mb-4">Soy <span className="font-semibold">Ingeniero de Software y Diseñador UI</span>. Vivo en Ciudad de México, Ajuaaaa!! Actualmente, estoy desarrollando plataformas y sitios web utilizando Jamstack y trabajando como Líder Técnico en <a className="font-semibold text-primary-300 hover:text-primary-400 transition duration-300 ease-in-out border-b-2 border-primary-300 hover:border-primary-400" href="https://bedu.org">Bedu</a>. Principalmente hago desarrollo <span className="font-medium text-yellow-600">front-end</span> pero también hago <span className="font-medium text-gray-200">back-end</span>.</p>
      </Container>
    </section>
    <section className="py-5 md:pt-5 md:pb-0">
      <Container className="max-w-3xl">
        <h2 className="inline-block font-inter font-bold text-gray-200 text-xl md:text-2.5xl mb-6">
          Más popular
        </h2>
    ...
    <section className="py-5 md:py-10">
      <Container className="max-w-3xl">
        <h2 className="inline-block font-inter font-bold text-gray-200 text-xl md:text-2.5xl mb-6">Últimos diseños</h2>
        <div className="grid md:grid-cols-2 gap-4">
          <Shots shots={shots} />
        </div>
        <div className="py-10 text-center">
          <a className="inline-flex items-center p-4 md:py-4 md:px-6 rounded-lg text-primary-300 font-semibold bg-dark-800 lg:bg-transparent lg:hover:bg-dark-800 transition duration-300 ease-in-out" href={SiteData.social.dribbble}>
            <span className="hidden md:inline-flex items-center py-1 px-2 bg-primary-300 text-darken text-sm rounded uppercase mr-3 leading-none">Nuevo</span>
