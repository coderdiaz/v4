---
layout: post
title: "Creando relaciones many-to-many con TypeORM: Parte 1"
description: "Las relaciones many-to-many o también conocidas como relaciones muchos a muchos, es una estrategia en base de datos que nos permite relacionar dos o más entidades en una tabla de referencia o también llamada, pivote."
...
<Figure src="/static/creando-relaciones-many-to-many-con-typeorm/first-database-schema.png" alt="Tablas autogeneradas por TypeORM" />
...
<Figure src="/static/creando-relaciones-many-to-many-con-typeorm/database-schema.png" alt="Modelo entidad relación" />
