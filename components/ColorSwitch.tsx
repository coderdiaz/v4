...
const ColorSwitch = () => {
  ...
  return <button onClick={darkMode.toggle} className="inline-flex items-center text-dark-500 hover:text-dark-800 md:bg-gray-50 md:hover:bg-gray-100 rounded p-3 transition duration-300 ease-in-out fill-current" aria-label="Dark Mode">
